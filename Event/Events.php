...
final class Events
{
     ...
     */
    const string BULK = 'ongr.es.event.bulk';

    /**
     * The PRE_COMMIT event occurs before committing queries to ES
     */
    const string PRE_COMMIT = 'ongr.es.event.pre_commit';

    /**
     * The POST_COMMIT event occurs after committing queries to ES
     */
    const string POST_COMMIT = 'ongr.es.event.post_commit';
     ...
     */
    const string POST_CLIENT_CREATE = 'ongr.es.event.post_client_create';
}
